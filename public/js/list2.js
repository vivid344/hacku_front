function init() {
    ...
    for (i = 0; i < tmp.length; i++) {
        if (tmp[i].status == "doing") {
            ...
            $("#list").append('<a onclick="fire_button()"><div style="border-bottom: solid 1px #EBEBEB" class="mdl-list__item"><span class="mdl-list__item-primary-content"><i class="material-icons mdl-list__item-avatar">group</i><span>' + tmp[i].g_name + '</span></span><i class="material-icons mini">event_busy</i></div></a>');
        }
    }
}